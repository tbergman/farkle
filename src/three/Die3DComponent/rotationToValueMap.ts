...
rotationToValueMap.set([-pi, pi/2, 0].toString(), 3)
rotationToValueMap.set([pi/2, pi/2, 0].toString(), 2)
rotationToValueMap.set([-pi/2, pi/2, 0].toString(), 5)
// ----- y = -pi/2 ----- //
...
rotationToValueMap.set([-pi, pi/2, pi].toString(), 4)
rotationToValueMap.set([pi/2, pi/2, pi].toString(), 5)
rotationToValueMap.set([-pi/2, pi/2, pi].toString(), 2)
// ----- y = -pi/2 ----- //
...
rotationToValueMap.set([-pi, 0, pi/2].toString(), 6)
rotationToValueMap.set([pi/2, 0, pi/2].toString(), 3)
rotationToValueMap.set([-pi/2, 0, pi/2].toString(), 4)
// ----- y = pi ----- //
rotationToValueMap.set([0, pi, pi/2].toString(), 6)
rotationToValueMap.set([pi, pi, pi/2].toString(), 1)
rotationToValueMap.set([-pi, pi, pi/2].toString(), 1)
rotationToValueMap.set([pi/2, pi, pi/2].toString(), 3)
rotationToValueMap.set([-pi/2, pi, pi/2].toString(), 4)
// ----- y = -pi ----- //
rotationToValueMap.set([0, -pi, pi/2].toString(), 6)
rotationToValueMap.set([pi, -pi, pi/2].toString(), 1)
rotationToValueMap.set([-pi, -pi, pi/2].toString(), 1)
...
rotationToValueMap.set([-pi, pi/2, pi/2].toString(), 5)
rotationToValueMap.set([pi/2, pi/2, pi/2].toString(), 3)
rotationToValueMap.set([-pi/2, pi/2, pi/2].toString(), 4)
// ----- y = -pi/2 ----- //
